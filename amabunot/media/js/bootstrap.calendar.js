...
;(function ( $, window, document, undefined ) {
    ...
    var pluginName = 'Calendar',
        ...
        template =  ''+
                        '<div class="header"><div class="month"></div><div class="year"></div></div>' +
                        '<table class="calendar" id="calendar">' +
                            '<thead class="calendar-header"></thead>' +
                            '<tbody class="calendar-body"></tbody>' +
                            '<tfoot>'+
                                '<th colspan="1" class="sel" id="last"><div class="arrow"><i class="icon-arrow-left"></i></div></th>'+
                                '<th colspan="2">' +
                                '<th colspan="1" class="sel" id="current">' +defaults.msg_today+ '</th>'+
                                '<th colspan="2">' +
                                '<th colspan="1" class="sel" id="next"><div class="arrow"><i class="icon-arrow-right"></i></div></th>'+
                            '</tfoot>'+
                        '</table>'+
                    '',
        ...
        for(var i=1; i<=daysInMonth[live_date.getMonth()]; i++){
            $.each(events.event, function(){
                ...
                if( event_date.getDate() == view_date.getDate()
                    ...
                    .empty()
                    .append('<span class="weekday upper">' +i+ '</span>')
                    .popover({
                        'title': msg_evnts_hdr,
                        'content': this.title,
        ...
        for(var i=0; i>=last; i++){
            ...
            for(var j=this.weekStart; j<this.days.length + this.weekStart; j++){
                ...
                if(dow == 0){
                    ...
                    _html += '<td class="' +cls+ '" id="'+id+'" year="' + year + '" month="' + month_ + '" day="' + dow + '"><span class="weekday upper">' +dow+ '</span></td>';
                }else{
                    _html += '<td class="' +cls+ '" id="'+id+'" year="' + year + '" month="' + month_ + '" day="' + dow + '"><span class="upper">' +dow+ '</span></td>';
                }
